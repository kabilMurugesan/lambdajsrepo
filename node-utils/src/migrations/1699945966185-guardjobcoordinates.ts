...
export class guardjobcoordinates1699945966185 implements MigrationInterface {
    name = 'guardjobcoordinates1699945966185'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`job_guards\` (\`id\` varchar(36) NOT NULL, \`job_id\` varchar(255) NOT NULL, \`user_id\` varchar(255) NOT NULL, \`is_punch\` tinyint NULL, \`guard_in_time\` timestamp NULL, \`guard_out_time\` timestamp NULL, \`team_id\` varchar(255) NULL, \`job_status\` int NOT NULL COMMENT '0-PENDING, 1-ACCEPTED, 2-REJECTED' DEFAULT '0', \`created_by\` varchar(255) NULL, \`created_on\` timestamp NULL, \`updated_by\` varchar(255) NULL, \`updated_on\` timestamp NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
